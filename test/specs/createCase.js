...
describe("Tests Create New Case Functionality", () => {
  ...
  it("Positive Test: Add an Event, then remove- GOOD- WAS BUG", async () => {
  ...
  //     const affiliatedCard = await Case.affiliatedCard();
  //     const remainingParties = await affiliatedCard.$$(
  //       Case.deleteAffiliatedCard(),
  //     );
